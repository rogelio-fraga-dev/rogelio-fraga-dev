...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=700&size=20&duration=3000&pause=1000&color=7DD3FC&center=true&vCenter=true&width=750&lines=Building+Decision-Driven+Systems;Arquitetura+Orientada+a+Regras;Java+%2B+Spring+Boot+Backend;Angular+%2B+TypeScript+Frontend;Clean+Code+%7C+SOLID+%7C+Design+Patterns;Docker+%7C+Observability+%7C+Scalability)](https://git.io/typing-svg)
